...
import pers.zcc.scm.common.excel.interfaces.ExcelDataConsumerException;
import pers.zcc.scm.common.excel.interfaces.ExcelMapConfigException;
import pers.zcc.scm.common.excel.interfaces.ExcelProcessAbortedException;
import pers.zcc.scm.common.excel.interfaces.IExcelImportAssistant;
import pers.zcc.scm.common.excel.interfaces.IExcelImportDataConsumer;
import pers.zcc.scm.common.excel.vo.ExcelDataVO;
import pers.zcc.scm.common.excel.vo.ExcelImportVO;
import pers.zcc.scm.common.excel.vo.ExcelRowMapVO;
import pers.zcc.scm.common.excel.vo.ExcelSheetMapVO;
...
public class ExcelImportAssistant implements IExcelImportAssistant {
        ...
        executor.submit(() -> {
            ...
            for (int i = 0; i < sheetMapperList.size(); i++) {
                ...
                futureArr[i] = CompletableFuture.runAsync(() -> {
                    ...
                    IExcelImportDataConsumer consumer = (IExcelImportDataConsumer) ApplicationContextManager
                            .getBean(consumerBeanName);
    ...
    private void batchConsumeData(Long eventId, Sheet sheet, ExcelSheetMapVO<?> sheetMapper,
        ...
        for (int i = 1; i < total; i++) {
            ...
            for (int j = 0; j < headerMapper.size(); j++) {
                ...
                try {
                    pd.getWriteMethod().invoke(vo, value);
    ...
    public boolean parseAndSetProp(Object target, Cell source, ExcelRowMapVO<?> importMap, List<ExcelErrorVO> errorList,
            Long eventId, int rowIdx, int columnIdx) {
