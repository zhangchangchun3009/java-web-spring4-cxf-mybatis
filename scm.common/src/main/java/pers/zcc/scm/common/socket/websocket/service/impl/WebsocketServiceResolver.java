...
import pers.zcc.scm.common.socket.websocket.service.interfaces.EndPoint;
import pers.zcc.scm.common.socket.websocket.service.interfaces.MsgHandle;
import pers.zcc.scm.common.socket.websocket.service.interfaces.WebsocketService;
import pers.zcc.scm.common.util.ApplicationContextManager;

@Named
public class WebsocketServiceResolver implements IAfterStartUpHandle {
